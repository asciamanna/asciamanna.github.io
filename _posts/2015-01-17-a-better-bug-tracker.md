...
Unit tests should also be written for every bug that was found. A bug should not be fixed unless there is a failing test that exposes the bug. This will give your team the confidence that you will never have to fix the same bug twice.  
